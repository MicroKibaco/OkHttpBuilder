...
import com.asiainfo.db.DownloadEntity;
...
public class DownloadEntityDao extends AbstractDao<DownloadEntity, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Download_url = new Property(3, Long.class, "download_url", false, "DOWNLOAD_URL");
        public final static Property Thread_id = new Property(4, Long.class, "thread_id", false, "THREAD_ID");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DOWNLOAD_ENTITY\" (" + //
                ...
                "\"DOWNLOAD_URL\" INTEGER," + // 3: download_url
    ...
    protected void bindValues(SQLiteStatement stmt, DownloadEntity entity) {
        ...
        Long download_url = entity.getDownload_url();
        if (download_url != null) {
            stmt.bindLong(4, download_url);
        }
    ...
    public DownloadEntity readEntity(Cursor cursor, int offset) {
        DownloadEntity entity = new DownloadEntity( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3), // download_url
            cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4), // thread_id
    ...
    public void readEntity(Cursor cursor, DownloadEntity entity, int offset) {
        ...
        entity.setDownload_url(cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3));
        entity.setThread_id(cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4));
